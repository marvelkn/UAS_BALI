...
import '../App.css';
import { data } from '../../components/Tegenungan/QuesTegenungan';
import { Link } from 'react-router-dom';

const QuizTegenungan = () => {
    // State variables
    ...
    useEffect(() => {
        const savedScore = localStorage.getItem('quizTegenunganScore');
        if (savedScore) {
