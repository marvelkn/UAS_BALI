...
import '../App.css';
import { data } from '../../components/PantaiKuta/QuesPantaiKuta';
import { Link } from 'react-router-dom';

const QuizPantaiKuta = () => {
    // State variables
    ...
    useEffect(() => {
        const savedScore = localStorage.getItem('quizPantaiKutaScore');
        if (savedScore) {
