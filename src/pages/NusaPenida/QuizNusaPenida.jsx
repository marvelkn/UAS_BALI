...
import '../App.css';
import { data } from '../../components/NusaPenida/QuesNusaPenida';
import { Link } from 'react-router-dom';

const QuizNusaPenida = () => {
    // State variables
    ...
    useEffect(() => {
        const savedScore = localStorage.getItem('quizNusaPenidaScore');
        if (savedScore) {
